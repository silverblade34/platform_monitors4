            ...
            <v-card min-width="200">
                ...
                <v-list>
                    <v-list-item class="px-5">
                        <div class="cursor-pointer transition hover:text-indigo-400
                        ease-in duration-100 flex gap-2 rounded-lg items-center text-gray-400 text-sm py-2">
                    ...
                    <v-list-item class="px-3">
                        <div class="py-2 px-5 bg-indigo-400 hover:bg-indigo-500 cursor-pointer transition 
